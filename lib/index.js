...
exports.DeployWebpackPlugin = void 0;
var path = __importStar(require("path"));
var fs = __importStar(require("fs"));
var tomcat_deployer_1 = require("tomcat-deployer");
var _name = 'deploy-webpack-plugin';
var DeployWebpackPlugin = /** @class */ (function () {
    function DeployWebpackPlugin(options) {
        if (options === void 0) { options = {}; }
        this._opts = __assign({}, options);
    }
    DeployWebpackPlugin.prototype.deploy = function (compilation, logger) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, tomcat.deploy(warFile, this._opts.contextPath)];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        e_1 = _a.sent();
                        logger.info('The war file “%s” deploy failed: %s', warFile, e_1);
                        return [3 /*break*/, 4];
    ...
    DeployWebpackPlugin.prototype.apply = function (compiler) {
        var _this = this;
        compiler.hooks.afterEmit.tapAsync(_name, function (compilation, callback) {
            var logger = compiler.getInfrastructureLogger(_name);
            _this.deploy(compilation, logger).then(function () { return callback(); });
        });
    };
    return DeployWebpackPlugin;
}());
exports.DeployWebpackPlugin = DeployWebpackPlugin;
