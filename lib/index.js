...
var DeployWebpackPlugin = /** @class */ (function () {
    ...
    DeployWebpackPlugin.prototype.apply = function (compiler) {
        var _this = this;
        compiler.hooks.afterEmit.tapAsync(DeployWebpackPlugin.pluginName, function (compilation, callback) {
            var logger = compiler.getInfrastructureLogger(DeployWebpackPlugin.pluginName);
            _this.deploy(compilation, logger).then(function () { return callback(); });
        });
    };
    DeployWebpackPlugin.pluginName = 'deploy-webpack-plugin';
